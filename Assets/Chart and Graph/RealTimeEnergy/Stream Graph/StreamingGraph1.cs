...
public class StreamingGraph1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (lastTime + 2f < time)
        {
            ...
            //Graph.DataSource.AddPointToCategoryRealtime("Player 1", System.DateTime.Now, cur); // each time we call AddPointToCategory 
            Graph.DataSource.AddPointToCategoryRealtime("Device 2", System.DateTime.Now, cur1);
