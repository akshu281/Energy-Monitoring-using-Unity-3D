...
public class StreamingGraph : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (lastTime + 2f < time)
        {
            ...
            Graph.DataSource.AddPointToCategoryRealtime("Device 1", System.DateTime.Now, cur); // each time we call AddPointToCategory 
            //Graph.DataSource.AddPointToCategoryRealtime("Player 2", System.DateTime.Now, cur1);
